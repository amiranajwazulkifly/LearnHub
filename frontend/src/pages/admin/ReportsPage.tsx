        ...
        <ChartCard title="Enrollments — Last 30 Days">
          <ResponsiveContainer width="100%" height={240}>
            <LineChart data={trend}>
              ...
              <Tooltip />
              <Line type="monotone" dataKey="count" stroke="#7F00FF" strokeWidth={2} dot={false} />
            </LineChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Most Popular Courses">
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={popularity}>
              ...
              <YAxis allowDecimals={false} />
              <Tooltip />
              <Bar dataKey="enrollmentCount" fill="#7F00FF" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>
                ...
                <td className="px-4 py-2 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="h-1.5 w-24 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                      <div className="h-full bg-linear-to-r from-brand-600 to-brand-500" style={{ width: `${c.completionRate}%` }} />
                    </div>
